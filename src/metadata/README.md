 ...
 * [bryo.yml](bryo.yml)
     * Determines how your purl.obolibrary.org/obo/bryo/ redirects will be handled
     ...
     * Paste in the contents of [bryo.yml](bryo.yml)
 ...
 * [bryo.md](bryo.md)
     ...
     * Paste in the contents of [bryo.md](bryo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
