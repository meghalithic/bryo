These notes are for the EDITORS of bryo
...
Make sure you have an ID range in the [idranges file](bryo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [bryo-edit.owl](bryo-edit.owl)

** DO NOT EDIT bryo.obo OR bryo.owl in the top level directory **

[../../bryo.owl](../../bryo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/megbalk/bryo) for details.
 ...
 * [bryo-idranges.owl](bryo-idranges.owl)
...
This generates derived files such as bryo.owl and bryo.obo and places
 ...
 * https://github.com/megbalk/bryo/releases
 * https://github.com/megbalk/bryo/releases/new
...
what is in the `owl:versionIRI` of the derived bryo.owl (`data-version` in
bryo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/bryo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/bryo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/megbalk/bryo.svg?branch=master)](https://travis-ci.org/megbalk/bryo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/megbalk](https://travis-ci.org/profile/megbalk)
 2. click the "Sync account" button
 3. Click the tick symbol next to bryo
